...
$(document).ready(function(){
  ...
  $("#favoritesAllBtn").click(function(event) {
    ...
    $.get(`https://my-sweater-weather.herokuapp.com/api/v1/favorites?api_key=${document.cookie}`, function(data, status) {
      let favorited = data["data"]
      $(".fav1").html(`${favorited[0]["attributes"]["location"]}, <br> ${favorited[0]["attributes"]["current_weather"]["summary"]} <input id="deleteFavBtn" type="submit" value="Hide Favorites">`)
      $(".fav2").html(`${favorited[1]["attributes"]["location"]}, <br> ${favorited[1]["attributes"]["current_weather"]["summary"]} <input id="deleteFavBtn" type="submit" value="Hide Favorites">`)
      $(".fav3").html(`${favorited[2]["attributes"]["location"]}, <br> ${favorited[2]["attributes"]["current_weather"]["summary"]} <input id="deleteFavBtn" type="submit" value="Hide Favorites">`)
      $(".fav4").html(`${favorited[3]["attributes"]["location"]}, <br> ${favorited[3]["attributes"]["current_weather"]["summary"]} <input id="deleteFavBtn" type="submit" value="Hide Favorites">`)
      $(".fav5").html(`${favorited[4]["attributes"]["location"]}, <br> ${favorited[4]["attributes"]["current_weather"]["summary"]} <input id="deleteFavBtn" type="submit" value="Hide Favorites">`)
    })
  });
